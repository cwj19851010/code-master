    ...
    <el-card shadow="never">
      ...
      <el-descriptions :column="2" border v-loading="loading">
        ...
        <el-descriptions-item :label="t('visible')">
          <el-tag :type="menuDetail.visible ? 'success' : 'info'">
            {{ menuDetail.visible ? t('show') : t('hide') }}
          </el-tag>
        </el-descriptions-item>
        ...
        <el-descriptions-item :label="t('isCache')">
          <el-tag :type="menuDetail.isCache ? 'success' : 'info'">
            {{ menuDetail.isCache ? t('cache') : t('noCache') }}
          </el-tag>
        </el-descriptions-item>
