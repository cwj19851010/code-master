    ...
    <el-card shadow="never" class="mb-20">
      <el-form :inline="true" :model="queryForm" class="query-form">
        ...
        <el-form-item :label="t('login_ip')">
          <el-input v-model="queryForm.loginIp" :placeholder="$t2('please_input', 'login_ip')" clearable />
        </el-form-item>
        <el-form-item :label="t('login_status')">
          <el-select v-model="queryForm.status" :placeholder="$t2('please_select', 'status')" clearable>
            <el-option :label="t('login_success')" :value="0" />
            <el-option :label="t('login_failed')" :value="1" />
          </el-select>
        </el-form-item>
        <el-form-item>
        ...
        <el-table-column prop="status" :label="t('login_status')" width="100">
          <template #default="{ row }">
            <el-tag :type="row.status === 0 ? 'success' : 'danger'">
              {{ row.status === 0 ? t('login_success') : t('login_failed') }}
            </el-tag>
          </template>
        </el-table-column>
