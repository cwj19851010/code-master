    ...
    <el-card shadow="never" class="mb-20">
      <el-form :inline="true" :model="queryForm" class="query-form">
        <el-form-item :label="t('task_name')">
          <el-input v-model="queryForm.taskName" :placeholder="t2('please_input', 'name')" clearable />
        </el-form-item>
        <el-form-item :label="t('task_id')">
          <el-input v-model="queryForm.taskId" :placeholder="t2('please_input', 'name')" clearable />
        </el-form-item>
