    ...
    <el-card shadow="never" class="mb-20">
      <el-form :inline="true" :model="queryForm" class="query-form">
        <el-form-item :label="t('task_name')">
          <el-input v-model="queryForm.taskName" :placeholder="t('please_input_name')" clearable style="width: 180px;" />
        </el-form-item>
        <el-form-item :label="t('job_group')">
          <el-input v-model="queryForm.jobGroup" :placeholder="t('please_input_name')" clearable style="width: 180px;" />
        </el-form-item>
        <el-form-item :label="t('task_type')">
          <el-select v-model="queryForm.taskType" :placeholder="t('please_select')" clearable style="width: 180px;">
        ...
        <el-form-item :label="t('status')">
          <el-select v-model="queryForm.status" :placeholder="t('please_select_status')" clearable style="width: 180px;">
            <el-option :label="t('status_normal')" :value="0" />
            <el-option :label="t('status_paused')" :value="1" />
          </el-select>
        </el-form-item>
        <el-form-item>
