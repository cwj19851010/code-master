  ...
  <div class="app-container">
    <el-card shadow="never" class="mb-20">
      <el-form :inline="true" :model="queryForm" class="query-form">
        <el-form-item :label="t('file_name')">
          <el-input v-model="queryForm.fileName" :placeholder="t('please_input_name')" clearable style="width: 180px;" />
        </el-form-item>
        <el-form-item :label="t('file_type')">
          <el-input v-model="queryForm.fileType" :placeholder="t('please_input_name')" clearable style="width: 180px;" />
        </el-form-item>
        <el-form-item>
    ...
    <el-card shadow="never">
      ...
      <el-table
        ...
        <el-table-column prop="createBy" :label="t('upload_user')" width="120" />
        <el-table-column prop="createTime" :label="t('upload_time')" width="180">
          <template #default="{ row }">
