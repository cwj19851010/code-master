    ...
    <el-card shadow="never" v-loading="loading">
      ...
      >
        <el-form-item :label="t('code')" prop="tenantCode">
          <el-input v-model="form.tenantCode" :placeholder="t2('please_input', 'code')" disabled />
        </el-form-item>
        ...
        <el-form-item :label="t('isolation_type')" prop="isolationType">
          <el-radio-group v-model="form.isolationType" disabled>
...
import { t2 } from '@/i18n'
import { getById, update, testConnection } from '@/api/system/tenant'
