    ...
    <el-card shadow="never" class="mb-20">
      <el-form :inline="true" :model="queryForm" class="query-form">
        <el-form-item :label="t('code')">
          <el-input v-model="queryForm.tenantCode" :placeholder="t('please_input_code')" clearable style="width: 180px;" />
        </el-form-item>
        <el-form-item :label="t('name')">
          <el-input v-model="queryForm.tenantName" :placeholder="t('please_input_name')" clearable style="width: 180px;" />
        </el-form-item>
        <el-form-item :label="t('isolation_type')">
          <el-select v-model="queryForm.isolationType" :placeholder="t('please_select_isolation')" clearable style="width: 180px;">
