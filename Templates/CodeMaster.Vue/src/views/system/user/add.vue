    ...
    <el-card shadow="never">
      ...
      >
        <el-form-item :label="t('username')" prop="userName">
          <el-input v-model="form.userName" :placeholder="t2('please_input', 'username')" />
        </el-form-item>

        <el-form-item :label="t('password')" prop="password">
          <el-input v-model="form.password" type="password" :placeholder="t2('please_input', 'password')" show-password />
        </el-form-item>
...
import { t2 } from '@/i18n'
import { create } from '@/api/system/user'
...
const rules = {
  userName: [
    { required: true, message: t2('please_input', 'username'), trigger: 'blur' },
    { min: 2, max: 20, message: t2('length_error', 'username'), trigger: 'blur' }
  ],
  password: [
    { required: true, message: t2('please_input', 'password'), trigger: 'blur' },
    { min: 6, max: 20, message: t2('length_error', 'password'), trigger: 'blur' }
  ],
  nickName: [
