  ...
  <div class="app-container">
    <el-card shadow="never" class="mb-20">
      <el-form :inline="true" :model="queryForm" class="query-form">
        <el-form-item :label="t('dictName')">
          <el-input v-model="queryForm.dictName" :placeholder="t('please_input_dictName')" clearable />
        </el-form-item>
        <el-form-item :label="t('dictType')">
          <el-input v-model="queryForm.dictType" :placeholder="t('please_input_dictType')" clearable />
        </el-form-item>
        <el-form-item :label="t('label')">
          <el-input v-model="queryForm.label" :placeholder="t('please_input_label')" clearable />
        </el-form-item>
        <el-form-item :label="t('value')">
          <el-input v-model="queryForm.value" :placeholder="t('please_input_value')" clearable />
        </el-form-item>
        <el-form-item :label="t('lang_key')">
          <el-input v-model="queryForm.langKey" :placeholder="t('please_input_lang_key')" clearable />
        </el-form-item>
    ...
    <el-card shadow="never">
      ...
      <el-table
          ...
          default-expand-all
        >
        <el-table-column prop="dictName" :label="t('dictName')" width="200" />
        ...
        <el-table-column prop="label" :label="t('label')" width="150">
          <template #default="{ row }">
            <template v-if="row.label">
              {{ row.langKey ? t(row.langKey) : row.label }}
            </template>
          </template>
        </el-table-column>
