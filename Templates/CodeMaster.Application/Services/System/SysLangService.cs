...
public interface ISysLangService : IApplicationService
{
    ...
    Task<bool> UpdateAsync(UpdateSysLangDto dto);
...
public class SysLangService : ISysLangService
{
    ...
    {
        var result = await _langRepository.GetPagedListAsync(
            where: l =>
                (string.IsNullOrEmpty(query.LangCode) || l.LangCode.Contains(query.LangCode)) &&
                (string.IsNullOrEmpty(query.LangName) || l.LangName.Contains(query.LangName)) &&
                (query.IsEnabled == null || l.IsEnabled == query.IsEnabled.Value),
            pageNum: query.PageNum,
            pageSize: query.PageSize);

        return new PagedResultDto<SysLangDto>
        {
            Items = result.Items.Adapt<List<SysLangDto>>(),
            Total = result.Total,
            PageNum = query.PageNum,
            PageSize = query.PageSize
        };
    ...
    public async Task<bool> UpdateAsync(UpdateSysLangDto dto)
    {
...
public interface ISysLangTextService : IApplicationService
{
    ...
    Task<bool> UpdateAsync(UpdateSysLangTextDto dto);
...
public class SysLangTextService : ISysLangTextService
{
    ...
    public async Task<bool> UpdateAsync(UpdateSysLangTextDto dto)
    {
