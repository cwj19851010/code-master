...
public class SysTaskService : ISysTaskService
{
    ...
    [DynamicApi(HttpMethod = "POST", Route = "{id}/start")]
    ...
    [DynamicApi(HttpMethod = "POST", Route = "{id}/pause")]
    ...
    [DynamicApi(HttpMethod = "POST", Route = "{id}/resume")]
    ...
    [DynamicApi(HttpMethod = "POST", Route = "{id}/run")]
